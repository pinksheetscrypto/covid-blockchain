...
# Allows overriding the branch or commit to build in covid-blockchain-gui
SUBMODULE_BRANCH=$1
...
# https://github.com/pinksheetscrypto/covid-blockchain/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `covid version` to version property of GUI's package.json
