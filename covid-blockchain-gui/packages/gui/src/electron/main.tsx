...
import AppIcon from '../assets/img/covid64x64.png';
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/pinksheetscrypto/covid-blockchain/blob/main/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://twitter.com/CovidNetwork');
            },
          },
        ],
      },
