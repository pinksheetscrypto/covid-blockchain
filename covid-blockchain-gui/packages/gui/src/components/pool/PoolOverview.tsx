...
import { Flex, UnitFormat, More, Table, mojoToCovidLocaleString, Suspender } from '@covid/core';
...
import { WalletStatus } from '@covid/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToCovidLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
