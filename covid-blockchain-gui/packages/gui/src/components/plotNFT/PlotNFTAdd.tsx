...
import { useCreateNewPoolWalletMutation } from '@covid/api-react';
import { ChevronRight as ChevronRightIcon } from '@material-ui/icons';
import { Flex, Suspender } from '@covid/core';
  ...
  return (
    <>
      ...
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent COV farming rewards. The average
