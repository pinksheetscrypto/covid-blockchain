...
import { CardStep, Select, StateColor } from '@covid/core';
import { useGetPlottersQuery } from '@covid/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@covid/api';
import type { Plotter, PlotterMap } from '@covid/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => a == PlotterName.COVIDPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Covid Proof of Space plotter. If unsure,
            use the default Covid Proof of Space plotter.
        </Trans>
      </Typography>
