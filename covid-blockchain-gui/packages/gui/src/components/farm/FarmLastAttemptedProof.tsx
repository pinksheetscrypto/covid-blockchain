...
import { Link, Loading, Table, Card, FormatBytes } from '@covid/core';
import { useGetFarmingInfoQuery } from '@covid/api-react';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/pinksheetscrypto/covid-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
