...
This library provides react hooks on the top of @covid/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from Covid Blockchain).
...
import { useGetPublicKeysQuery } from '@covid/api-react';
...
import { store, api } from '@covid/api-react';
