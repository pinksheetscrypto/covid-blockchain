...
import covidToMojo from '../../utils/covidToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isCovidCurrency = ['COV', 'TCOV'].includes(currencyCode);
  const mojo = isCovidCurrency 
    ? covidToMojo(correctedValue) 
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isCovidCurrency ? 12 : 3,
          },
          endAdornment: (
