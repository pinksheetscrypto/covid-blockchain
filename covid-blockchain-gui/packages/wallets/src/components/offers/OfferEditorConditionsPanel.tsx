...
import { useGetWalletBalanceQuery, useGetWalletsQuery } from '@covid/api-react';
import { Wallet, WalletType } from '@covid/api';
    ...
    if (!isLoading && tradeSide === 'sell' && walletBalance && walletBalance.walletId == row.assetWalletId) {
      switch (item.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToCovidLocaleString(walletBalance.spendableBalance);
          balance = mojoToCovid(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:
