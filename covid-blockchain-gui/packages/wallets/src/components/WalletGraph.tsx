...
import { TransactionType } from '@covid/api';
import type { Transaction } from '@covid/api';
import { mojoToCovid, blockHeightToTimestamp } from '@covid/core';
  ...
  const points = [
    {
      ...
      y: Math.max(0, Number(mojoToCovid(start))),
      tooltip: mojoToCovid(balance),
    },
  ];
