...
} from '@covid/api-react';
import { SyncingStatus } from '@covid/api';
...
export default function WalletCATSend(props: Props) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    if (address.includes('colour')) {
      throw new Error(t`Cannot send covid to coloured address. Please enter a covid address.`);
    }
    ...
    const feeValue = covidToMojo(fee);
