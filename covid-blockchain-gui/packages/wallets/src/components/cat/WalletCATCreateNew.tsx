...
import { covidToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@covid/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = covidToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Covid Asset Token Wallet</Trans>
        </Back>
        <Card>
