...
This library provides support for TypeScript/JavaScript [Covid](https://www.covidnetwork.org) apps to access the [Covid Blockchain RPC](https://github.com/pinksheetscrypto/covid-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:

- Making requests to the Covid Blockchain RPC.
...
```ts
import Client, { Wallet } from '@covid/api';
