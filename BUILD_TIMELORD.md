...
required to run a [Timelord](https://github.com/pinksheetscrypto/covid-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/pinksheetscrypto/covid-blockchain/blob/main/install-timelord.sh)
