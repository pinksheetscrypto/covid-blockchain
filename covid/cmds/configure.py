...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "58444"
            testnet_introducer = "beta1_introducer.covid.pinksheetscrypto.com"
            testnet_dns_introducer = "dns-introducer-testnet7.covid.net"
            testnet = "testnet7"
            ...
            mainnet_dns_introducer = "dns-introducer.covid.covid.net"
            net = "mainnet"
