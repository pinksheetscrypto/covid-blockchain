...
from covid.util.config import get_config_lock, load_config, save_config, str2bool
    ...
    with get_config_lock(root_path, "config.yaml"):
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.covid.net"
                testnet_dns_introducer = "dns-introducer-testnet10.covid.net"
                bootstrap_peers = ["testnet10-node.covid.net"]
                testnet = "testnet10"
