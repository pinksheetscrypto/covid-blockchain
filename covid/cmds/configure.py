...
from covid.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "56888"
            testnet_introducer = "introducer-testnet10.covidnetwork.org"
            testnet_dns_introducer = "dns-introducer-testnet10.covidnetwork.org"
            bootstrap_peers = ["testnet10-node.covid.com"]
            testnet = "testnet10"
            ...
            mainnet_dns_introducer = "dns-introducer.covid.pinksheetscrypto.com"
            bootstrap_peers = ["node.covid.com"]
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running covid services for changes to take effect")
