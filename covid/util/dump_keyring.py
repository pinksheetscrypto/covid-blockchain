...
# Fix module resolution issue between covid/util/ssl.py and `import ssl`
# aiohttp imports ssl, which incorrectly finds covid/util/ssl.py. As a
# workaround, we'll place covid/util at the end of sys.path
...
if True:  # noqa: E402
    from covid.cmds.passphrase_funcs import prompt_for_passphrase, read_passphrase_from_file
    from covid.util.default_root import DEFAULT_KEYS_ROOT_PATH
    from covid.util.file_keyring import FileKeyring
    from covid.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE, KeyringWrapper
