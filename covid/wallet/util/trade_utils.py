...
from covid.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "covid" in cc_discrepancies:
                    cc_discrepancies["covid"] = cc_discrepancies["covid"] + diff
                else:
                    cc_discrepancies["covid"] = diff
