...
from covid.util.network import get_host_addr


def start_reconnect_task(server: CovidServer, peer_info_arg: PeerInfo, log, auth: bool, prefer_ipv6: Optional[bool]):
    """
