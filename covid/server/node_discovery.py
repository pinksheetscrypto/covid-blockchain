...
from covid.protocols import full_node_protocol, introducer_protocol
...
from covid.server.address_manager_sqlite_store import create_address_manager_from_db
...
class FullNodeDiscovery:
    ...
    async def on_connect_callback(self, peer: ws.WSCovidConnection):
