...
from covid.pools.pool_config import PoolWalletConfig
from covid.util.config import load_config, save_config, create_default_covid_config
...
def test_pool_config():
    ...
    create_default_covid_config(test_root, ["config.yaml"])
