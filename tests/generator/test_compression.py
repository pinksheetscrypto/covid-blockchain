...
from covid.full_node.generator import run_generator_unsafe, create_generator_args
...
DESERIALIZE_MOD = load_clvm("covidlisp_deserialisation.clvm", package_or_requirement="covid.wallet.puzzles")
