...
from covid.daemon.keychain_proxy import connect_to_keychain_and_validate, wrap_local_keychain
...
from covid.plotting.create_plots import create_plots, PlotKeys
...
from covid.consensus.condition_costs import ConditionCost
...
from covid.plotting.util import PlotsRefreshParameter, PlotRefreshResult, PlotRefreshEvents, parse_plot_info
from covid.plotting.manager import PlotManager
from covid.server.server import ssl_context_for_server
...
from covid.types.blockchain_format.program import INFINITE_COST
    ...
    async def setup_keys(self):
        if self.local_keychain:
            ...
            self.keychain_proxy = await connect_to_keychain_and_validate(
                self.root_path, log, user="testing-1.8.0", service="covid-testing-1.8.0"
            )
        ...
        try:
            if plot_keys is None:
                ...
                if pool_contract_puzzle_hash is None:
                    ...
                    pool_address = encode_puzzle_hash(pool_contract_puzzle_hash, "cov")
